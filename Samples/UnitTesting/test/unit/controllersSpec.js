...
describe('ReminderController Test', function() {
    ...
    beforeEach(function() {
    	...
    	inject(function($rootScope, $controller) {
              scope = $rootScope.$new();
              controller = $controller("ReminderController", {$scope: scope, reminderFactory:mockFactory });
    	});
    });
	
    it('should return reminders array with 2 elements, add one, and return 3', function() {
